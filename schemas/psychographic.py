...
class PsychographicVector:
    ...
    decision_style_dominant: str       # "analytical", "intuitive", "dependent", "avoidant", "spontaneous"
    ...
    employment_status: str             # "full_time", "part_time", "self_employed", "not_employed", "retired"
